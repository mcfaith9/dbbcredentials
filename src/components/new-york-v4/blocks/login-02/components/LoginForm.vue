    ...
    <FieldGroup>
      ...
      <Field>
        <div class="flex items-center justify-between">
          ...
          <a
            ...
            @click.prevent="error = 'Demo reset: use password123 or sign up for a new account.'"
          >
            Forgot password?
          </a>
        </div>
      ...
      <Field>
        ...
        <FieldDescription class="text-center mt-2">
          ...
          <router-link to="/signup" class="font-medium underline underline-offset-4 hover:text-primary">
            Sign up
          </router-link>
        </FieldDescription>
      </Field>
